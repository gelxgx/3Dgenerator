...
const versions = [
  { value: 'v2.0', label: 'Standard v2.0', badge: 'Economy' },
  { value: 'v2.5', label: 'Standard v2.5', badge: '' },
  { value: 'v3.0', label: 'Advanced v3.0', badge: '' },
  { value: 'v3.1', label: 'Advanced v3.1', badge: 'Latest' },
  { value: 'turbo', label: 'Turbo', badge: 'Fast' },
]
const selectedVersionLabel = computed(() => versions.find(v => v.value === modelVersion.value)?.label || 'Standard v2.0')
