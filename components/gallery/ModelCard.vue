...
<template>
  ...
  >
    ...
    <div class="relative w-full aspect-square overflow-hidden bg-dark-surface">
      <!-- 3D Model Preview (if modelUrl is a GLB) -->
      <ModelPreview3D
      ...
      <div class="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-dark-surface-alt/80 to-transparent pointer-events-none" />
      ...
      <div class="absolute inset-0 flex-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
        <div class="w-12 h-12 rounded-full bg-primary/20 backdrop-blur-md flex-center border border-primary/30">
          <i class="i-carbon-view text-xl text-white" />
        </div>
      </div>
    </div>
